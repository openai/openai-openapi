...
The YAML and JSON specifications are generated artifacts synchronized automatically from upstream source. See the [contribution policy](#contributing) and [feedback process](#feedback).
